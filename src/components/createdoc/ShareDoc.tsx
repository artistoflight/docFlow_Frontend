    ...
    <div>
      <AlertDialog>
        <AlertDialogTrigger
          ...
          <Button variant="default" className="py-2 px-5 h-fit w-fit">
            Share
          </Button>
        </AlertDialogTrigger>
        <AlertDialogContent className="md:w-2/3 min-h-40">
          {animation ? (
            ...
            <AlertDialogHeader className="text-left">
              <AlertDialogTitle>Share '{"document name"}'</AlertDialogTitle>
              <AlertDialogDescription>
                ...
                {shareEmail.length > 0 ? (
                  ...
                  <div>
                    <div className="my-2">
                      ...
                      <div
                        ...
                        <div className="text-left">
                          <div className="text-xs">Owner Name(You)</div>
                    ...
                    <div className="flex items-center justify-between h-fit mt-10">
                      <Button className="border-2 border-yellow-600 text-yellow-600 bg-white hover:text-white hover:bg-yellow-600">
                        <MdOutlineLink className="text-xl mr-2" /> Copy Link
                      </Button>
                      <AlertDialogCancel className="border-2 border-violet-600 text-violet-600 bg-white hover:text-white hover:bg-violet-600">
                        Done
                      </AlertDialogCancel>
                    </div>
                  </div>
